...
private:
    ...
    System::Windows::Forms::Button^ buttonOpenViewer;
    ...
    // Список для хранения всех регистров
    List<System::Tuple<int, float, int32_t>^>^ allRegistersData;

    // Флаг, открыта ли форма просмотра
    bool isViewerFormOpen;
private: System::Windows::Forms::Label^ labelFoundDevices;
private: System::Windows::Forms::TextBox^ textBoxScanResult;
    ...
    void ScanForDevices();
    void OpenRegistersViewer();
    void RefreshRegistersData();
    void ScanAllRegisters();
    void WriteRegisters(List<RegisterChange^>^ changes);
    ...
    void buttonOpenViewer_Click(System::Object^ sender, System::EventArgs^ e);
    void ViewerForm_FormClosed(System::Object^ sender, FormClosedEventArgs^ e);
};